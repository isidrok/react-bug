(function () {
	...
	*/
	...
	var LazyHello = function (_React$Component) {
	    inherits(LazyHello, _React$Component);

	    function LazyHello(props) {
	        classCallCheck(this, LazyHello);

	        var _this = possibleConstructorReturn(this, (LazyHello.__proto__ || Object.getPrototypeOf(LazyHello)).call(this, props));

	        _this.state = { component: null };
	        return _this;
	    }

	    createClass(LazyHello, [{
	        key: 'componentDidMount',
	        value: function componentDidMount() {
	            var _this2 = this;

	            setTimeout(function () {
	                return _this2.setState({ component: Hello });
	            }, 300);
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            var LazyComponent = this.state.component;
	            if (!LazyComponent) {
	                return react.createElement(
	                    'div',
	                    null,
	...
	var App = function (_React$Component2) {
	    ...
	    function App(props) {
	        ...
	        var _this3 = possibleConstructorReturn(this, (App.__proto__ || Object.getPrototypeOf(App)).call(this, props));
	    ...
	    createClass(App, [{
	        ...
	        value: function render() {
	            ...
	            return react.createElement(
	                ...
	                this.state.show && react.createElement(LazyHello, null)
	            );
	        }
	    }]);
	    return App;
